...
- Якщо відповідь обривається занадто рано:
  - збільшіть max_iterations на 2-3
- Якщо не знаходить локальні документи:
  - перевірте вміст data/
  - запустіть python ingest.py ще раз

## Зверніть увагу!
Пам’ять зберігається в межах сеансу, але через спільний thread_id нові питання можуть “успадковувати” попередній контекст і обходити повний мультиагентний маршрут.
